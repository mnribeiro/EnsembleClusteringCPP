...
namespace stemming
    ...
    static const wchar_t FINNISH_NA_UMLAUT[] = { 110, 0xE4, 0 };
    static const wchar_t FINNISH_TA_UMLAUT[] = { 116, 0xE4, 0 };
    static const wchar_t FINNISH_SSA_UMLAUT[] = { 115, 115, 0xE4, 0 };
    static const wchar_t FINNISH_STA_UMLAUT[] = { 115, 116, 0xE4, 0 };
    static const wchar_t FINNISH_LLA_UMLAUT[] = { 108, 108, 0xE4, 0 };
    static const wchar_t FINNISH_LTA_UMLAUT[] = { 108, 116, 0xE4, 0 };
    ...
    protected:
        ...
        inline bool is_suffix(const string_typeT& text,
                    wchar_t suffix1L, wchar_t suffix1U) const
            {
            if (text.length() < 1)
                { return false; }
        ...
        inline bool is_suffix(const string_typeT& text,
                    wchar_t suffix1L, wchar_t suffix1U,
                    wchar_t suffix2L, wchar_t suffix2U) const
            {
            if (text.length() < 2)
                {
                return false;
        ...
        inline bool is_suffix(const string_typeT& text,
                    wchar_t suffix1L, wchar_t suffix1U,
                    wchar_t suffix2L, wchar_t suffix2U,
                    wchar_t suffix3L, wchar_t suffix3U) const
            {
            if (text.length() < 3)
                {
                return false;
        ...
        inline bool is_suffix(const string_typeT& text,
                    wchar_t suffix1L, wchar_t suffix1U,
                    wchar_t suffix2L, wchar_t suffix2U,
                    wchar_t suffix3L, wchar_t suffix3U,
                    wchar_t suffix4L, wchar_t suffix4U) const
            {
            if (text.length() < 4)
                {
                return false;
        ...
        inline bool is_suffix(const string_typeT& text,
                    ...
                    wchar_t suffix2L, wchar_t suffix2U,
                    wchar_t suffix3L, wchar_t suffix3U,
                    wchar_t suffix4L, wchar_t suffix4U,
                    wchar_t suffix5L, wchar_t suffix5U) const
            {
            if (text.length() < 5)
                {
                return false;
        ...
        inline bool is_suffix(const string_typeT& text,
                    ...
                    wchar_t suffix3L, wchar_t suffix3U,
                    wchar_t suffix4L, wchar_t suffix4U,
                    wchar_t suffix5L, wchar_t suffix5U,
                    wchar_t suffix6L, wchar_t suffix6U) const
            {
            if (text.length() < 6)
                {
                return false;
        ...
        inline bool is_suffix(const string_typeT& text,
                    ...
                    wchar_t suffix4L, wchar_t suffix4U,
                    wchar_t suffix5L, wchar_t suffix5U,
                    wchar_t suffix6L, wchar_t suffix6U,
                    wchar_t suffix7L, wchar_t suffix7U) const
            {
            if (text.length() < 7)
                {
                return false;
        ...
        inline bool is_suffix(const string_typeT& text,
                    ...
                    wchar_t suffix5L, wchar_t suffix5U,
                    wchar_t suffix6L, wchar_t suffix6U,
                    wchar_t suffix7L, wchar_t suffix7U,
                    wchar_t suffix8L, wchar_t suffix8U) const
            {
            if (text.length() < 8)
                {
                return false;
        ...
        inline bool is_suffix(const string_typeT& text,
                    ...
                    wchar_t suffix6L, wchar_t suffix6U,
                    wchar_t suffix7L, wchar_t suffix7U,
                    wchar_t suffix8L, wchar_t suffix8U,
                    wchar_t suffix9L, wchar_t suffix9U) const
            {
            if (text.length() < 9)
                {
                return false;
        ...
        inline bool is_suffix_in_r1(const string_typeT& text,
            ...
            return (string_util::strnicmp(text.c_str()+(text.length()-suffix_length), suffix, suffix_length) == 0 &&
                    (get_r1() <= text.length()-suffix_length) );
            }
        ...
        inline bool is_suffix_in_r2(const string_typeT& text,
            ...
            return (string_util::strnicmp(text.c_str()+(text.length()-suffix_length), suffix, suffix_length) == 0 &&
                    (get_r2() <= text.length()-suffix_length) );
            }
        ...
        inline bool delete_if_is_in_r1(string_typeT& text,
            ...
            if (string_util::strnicmp(text.c_str()+(text.length()-suffix_length), suffix, suffix_length) == 0)
                {
                if (get_r1() <= text.length()-suffix_length)
                    {
        ...
        inline bool delete_if_is_in_r2(string_typeT& text,
            ...
            if (string_util::strnicmp(text.c_str()+(text.length()-suffix_length), suffix, suffix_length) == 0)
                {
                if (get_r2() <= text.length()-suffix_length)
                    {
                    text.erase(text.length()-suffix_length);
                    update_r_sections(text);
                    return true;
        ...
        inline bool delete_if_is_in_rv(string_typeT& text,
            ...
            if (string_util::strnicmp(text.c_str()+(text.length()-suffix_length), suffix, suffix_length) == 0)
                {
                if (get_rv() <= text.length()-suffix_length)
                    {
                    text.erase(text.length()-suffix_length);
                    update_r_sections(text);
                    return true;
    ...
    class no_op_stem : public stem<>
        {
    public:
        //---------------------------------------------
        inline void operator()(std::basic_string<wchar_t>& text)
            {}
        };
    }
