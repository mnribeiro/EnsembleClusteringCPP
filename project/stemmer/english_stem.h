...
namespace stemming
    ...
    private:
        ...
        void step_4(string_typeT& text)
            {
            if (is_suffix(text,/*ement*/LOWER_E, UPPER_E, LOWER_M, UPPER_M, LOWER_E, UPPER_E, LOWER_N, UPPER_N, LOWER_T, UPPER_T) )
                {
                if (stem<string_typeT>::get_r2() <= text.length()-5)
                    {
                    text.erase(text.length()-5);
            ...
            else if (is_suffix(text,/*ance*/LOWER_A, UPPER_A, LOWER_N, UPPER_N, LOWER_C, UPPER_C, LOWER_E, UPPER_E) )
                {
            ...
            else if (is_suffix(text,/*sion*/LOWER_S, UPPER_S, LOWER_I, UPPER_I, LOWER_O, UPPER_O, LOWER_N, UPPER_N) ||
            ...
            else if (is_suffix(text,/*able*/LOWER_A, UPPER_A, LOWER_B, UPPER_B, LOWER_L, UPPER_L, LOWER_E, UPPER_E) )
                {
                if (stem<string_typeT>::get_r2() <= text.length()-4)
                    {
                    text.erase(text.length()-4);
            ...
            else if (is_suffix(text,/*ible*/LOWER_I, UPPER_I, LOWER_B, UPPER_B, LOWER_L, UPPER_L, LOWER_E, UPPER_E) )
                {
                if (stem<string_typeT>::get_r2() <= text.length()-4)
                    {
                    text.erase(text.length()-4);
            ...
            else if (is_suffix(text,/*ant*/LOWER_A, UPPER_A, LOWER_N, UPPER_N, LOWER_T, UPPER_T) )
                {
                if (stem<string_typeT>::get_r2() <= text.length()-3)
                    {
                    text.erase(text.length()-3);
            ...
            else if (is_suffix(text,/*ent*/LOWER_E, UPPER_E, LOWER_N, UPPER_N, LOWER_T, UPPER_T) ||
            ...
            else if (is_suffix(text,/*al*/LOWER_A, UPPER_A, LOWER_L, UPPER_L) )
                {
            ...
            else if (is_suffix(text,/*er*/LOWER_E, UPPER_E, LOWER_R, UPPER_R) )
                {
                if (stem<string_typeT>::get_r2() <= text.length()-2)
                    {
                    text.erase(text.length()-2);
